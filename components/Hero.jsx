...
import React from 'react';
import { motion } from 'framer-motion';
import { TrendingUp, ArrowRight, ShieldCheck, Sparkles, Target, Settings, Menu, BarChart2, DollarSign, Users, Award } from 'lucide-react';
...
const KeyMetric = ({ icon: Icon, value, label, delay }) => (
  ...
  >
    <div className="w-14 h-14 mx-auto mb-4 p-3 rounded-full bg-indigo-50 flex items-center justify-center text-indigo-700">
      <Icon size={28} />
    </div>
...
const KeyMetrics = () => {
  const metrics = [
    { icon: DollarSign, value: "$500M+", label: "Assets Under Management", delay: 0.1 },
    { icon: Users, value: "15,000+", label: "Happy Investors", delay: 0.3 },
    { icon: BarChart2, value: "18.5%", label: "Average Annual Returns", delay: 0.5 },
    { icon: Award, value: "5 Yrs", label: "Industry Experience", delay: 0.7 },
  ];
  ...
  return (
    <section className="py-16 md:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-12 lg:mb-16">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-indigo-700 mb-4">Our Performance By The Numbers</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">Trust the data. Propel is engineered for long-term growth and stability.</p>
        </div>
...
const InvestmentFeatures = () => (
  <section className="py-16 md:py-24 bg-gray-50" id="tools">
    <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
      <motion.div
        ...
        viewport={{ once: true, amount: 0.5 }}
      >
        <h2 className="text-3xl sm:text-4xl font-extrabold text-indigo-700 mb-6">Tools Engineered for Financial Freedom</h2>
        <p className="text-lg text-gray-600 mb-10">
          Our platform offers robust features that put you in control of your portfolio, from automated rebalancing to advanced tax planning modules.
        </p>

        <div className="space-y-6">
          <div className="flex items-start gap-4 p-4 rounded-xl bg-white shadow-md border border-gray-100">
            <div className="flex-shrink-0 w-10 h-10 bg-indigo-100 rounded-full flex items-center justify-center text-indigo-700 mt-1">
              <Settings size={20} />
            </div>
            <div>
              <h3 className="text-xl font-bold text-gray-900">Automated Portfolio Rebalancing</h3>
              <p className="text-gray-600">Keep your risk profile constant without lifting a finger. Our AI monitors and adjusts your allocation quarterly.</p>
            </div>
          </div>
          <div className="flex items-start gap-4 p-4 rounded-xl bg-white shadow-md border border-gray-100">
            <div className="flex-shrink-0 w-10 h-10 bg-amber-100 rounded-full flex items-center justify-center text-amber-600 mt-1">
              <ShieldCheck size={20} />
            </div>
            <div>
              <h3 className="text-xl font-bold text-gray-900">Advanced Tax Harvesting</h3>
              <p className="text-gray-600">Minimise capital gains tax legally and automatically by booking losses to offset gains.</p>
            </div>
          </div>
          <div className="flex items-start gap-4 p-4 rounded-xl bg-white shadow-md border border-gray-100">
            <div className="flex-shrink-0 w-10 h-10 bg-green-100 rounded-full flex items-center justify-center text-green-600 mt-1">
              <TrendingUp size={20} />
            </div>
            <div>
              <h3 className="text-xl font-bold text-gray-900">Market-Beating Research</h3>
              <p className="text-gray-600">Access proprietary research reports and high-conviction mutual fund/stock picks from our expert team.</p>
            </div>
          </div>
        </div>
      </motion.div>

      {/* Placeholder Image of Dashboard/Chart - Visual Element added */}
      <motion.div
        initial={{ opacity: 0, scale: 0.9 }}
        whileInView={{ opacity: 1, scale: 1 }}
        transition={{ duration: 0.8, delay: 0.2 }}
        viewport={{ once: true, amount: 0.5 }}
        className="relative w-full h-80 lg:h-full flex items-center justify-center"
      >
        <div className="absolute inset-0 bg-indigo-700/5 rounded-3xl animate-pulse"></div>
        <div className="relative p-8 bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border-2 border-indigo-700/10 text-center w-full max-w-sm">
          <BarChart2 size={60} className="mx-auto mb-4 text-indigo-700" strokeWidth={1.5} />
          <h4 className="text-xl font-semibold text-gray-800">Visual Portfolio Analysis</h4>
...
const Header = () => (
  <header className="absolute top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-sm shadow-sm">
    <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
      ...
      <nav className="hidden md:flex space-x-6 text-gray-600 font-medium">
        <a href="#features" className="hover:text-indigo-700 transition-colors">Features</a>
        <a href="#tools" className="hover:text-indigo-700 transition-colors">Tools</a>
        <a href="#about" className="hover:text-indigo-700 transition-colors">About Us</a>
        <a href="#contact" className="hover:text-indigo-700 transition-colors">Contact</a>
      </nav>
      <div className="hidden md:block">
...
export default function App() {
  return (
    <div className="min-h-screen font-[Inter] antialiased">
      ...
      <Header />
      <Hero />
      <KeyMetrics /> {/* NEW SECTION: Financial Data */}
      <WhyChooseUs />
      <InvestmentFeatures /> {/* NEW SECTION: Investment-focused features with a visual */}
